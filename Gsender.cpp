...
Gsender::Gsender(String& login, String& password): _login(login), _password(password)
{

}

Gsender* Gsender::Instance(String& login, String& password)
{
    if (_instance == 0) 
        _instance = new Gsender( login, password);
    return _instance;
}
