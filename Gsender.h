...
{
    protected:
        Gsender(String& login, String& password);
    private:
        const int SMTP_PORT = 465;
        const char* SMTP_SERVER = "smtp.gmail.com";
        String _login;
        String _password;
        const char* EMAILBASE64_LOGIN = "ZHFteXVuQGdtYWlsLmNvbQ==";
        const char* EMAILBASE64_PASSWORD = "YWJlMXRhc21hbg==";
        const char* FROM = "dqmyun@gmail.com";
    ...
    public:
        static Gsender* Instance(String& login, String& password);
